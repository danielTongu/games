...
import { Room as SharedRoom } from "../../core/Room.js";
 ...
 */
export class Room extends SharedRoom {
    get players() { return this.circle.players; }
    /** @type {Promise<*>} */
    ...
    constructor(roomName, playerLimit = Constants.ROOM_PLAYER_LIMIT) {
        super(roomName, Room.#normalizePlayerLimit(playerLimit));
