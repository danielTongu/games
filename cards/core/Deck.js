...
export class Deck extends Serializable {
    ...
    reset(isShuffled = true) {
        ...
        for (const suit of Constants.CARD.STANDARD_SUITS) {
            for (const value of Constants.CARD.STANDARD_VALUES) {
                this.cards.push(new this.constructor.Card(value, suit));
            }
        }

        this.cards.push(new this.constructor.Card(Constants.CARD.VALUE.JOKER.id, Constants.CARD.SUIT.BLACK));
        this.cards.push(new this.constructor.Card(Constants.CARD.VALUE.JOKER.id, Constants.CARD.SUIT.RED));
     ...
     */
    putTop(card) {
        this.cards.push(this.constructor.Card.from(card));
    }
     ...
     */
    #putBottom(card) {
        this.cards.unshift(this.constructor.Card.from(card));
    }
